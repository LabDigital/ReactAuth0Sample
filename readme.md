...
```js
export const domain = "labcapacitorexample.eu.auth0.com";
export const clientId = "1IJ0JrdNHEbHGNYrdRAB6FNehrzRvd5O";
```
...
```text
com.auth0.samples://labcapacitorexample.eu.auth0.com/capacitor/com.auth0.samples/callback
```
